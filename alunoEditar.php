    ...
    <form method="post" action="alunoController.php">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" name="matricula" id="matricula" value="<?php echo $value->matricula; ?>"
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="nome" id="nome" value="<?php echo $value->nome; ?>" class="form-control"
                    aria-describedby="helpId">
            </div>

            <div class="form-group col-md-6">
                <label>E-mail</label>
                <input type="text" name="email" id="email" value="<?php echo $value->email; ?>" class="form-control"
                    aria-describedby="helpId">
            </div>
        </div>
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control" name="curso" id="curso">
                    ...
                    <option value="<?php echo $curso->id; ?>"
                        <?php echo ($curso->id == $value->curso_id) ? 'selected' : ''; ?>>
                        <?php echo $curso->sigla . ' - ' . $curso->nome; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="password" name="confirmaSenha" id="confirmaSenha" class="form-control"
                    onblur="validarSenha()" aria-describedby="helpId">
            </div>
        </div>
